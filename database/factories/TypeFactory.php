...
$factory->define(
    ...
    function (Faker $faker) {
        ...
        $forms = [
            ...
            '[{"type":"text","label":"Label","className":"form-control","name":"serial","subtype":"text"},{"type":"text","label":"Something","className":"form-control","name":"something","subtype":"text"},{"type":"radio-group","label":"Yes Or No","inline":true,"name":"radio-group-1578085735545","values":[{"label":"Yes","value":"yes"},{"label":"No","value":"no"}]}]',
